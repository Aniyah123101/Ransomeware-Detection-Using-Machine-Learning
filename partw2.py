...
from sklearn.preprocessing import StandardScaler  # Importing scaler for data scaling
...
# Load the dataset
df = pd.read_csv('data_file.csv')  # Replace 'data_file.csv' with your ransomware dataset
